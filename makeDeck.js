...
var deck = [];
var gator = gators[Math.floor(Math.random() * gators.length)];
...
var lastCard = {};
console.log("<div>\n");
console.log("<p><a href=\"" + gator.url + "\">" + gator.name + "</a> Deck for Chaos Ultimatum</p>\n");
console.log("<p>Total cards: " + deck.length + "</p>\n");

gator["deck_options"].map(function (o) {
    if (o.faction) {

        o.faction.map(function (f) {
            console.log("<p>" + f + ": " + countFactionsInDeck(deck, [f]) + "</p>\n");
        });
...
gator["deck_options"].map(function (o) {
    if (o.trait) {
        ...
        o.trait.map(function (t) {
            console.log("<p>" + t + ": " + countFactionsInDeck(deck, [t]) + "</p>\n");
        });
        
    }
});

console.log("<blockquote>" + gator["back_text"] + "</blockquote>\n");
console.log("</div>\n");
console.log("<table>\n");
console.log("<tr>\n");
console.log("<th>Name</th>\n");
console.log("<th>Quantity</th>\n");
console.log("<th>Type</th>\n");
console.log("<th>Faction</th>\n");
console.log("<th>Traits</th>\n");
console.log("</tr>\n");
for (i in deck) {

    if (lastCard.name && lastCard.name !== deck[i].name) {
        console.log("<tr>\n");
        console.log("<td><a href=\"" + lastCard.url + "\">" + lastCard.name + "</a></td>\n");
        console.log("<td> x" + count + "</td>\n");
        console.log("<td>" + lastCard["type_name"] + "</td>\n");
        console.log("<td>" + lastCard["faction_name"] + "</td>\n");
        if (lastCard["traits"]) {
            console.log("<td>" + lastCard["traits"] + "</td>\n");
        }
        console.log("</tr>\n");
        count = 0;
    }
...
console.log("<tr>\n");
console.log("<td><a href=\"" + lastCard.url + "\">" + lastCard.name + " x" + count + "</a></td>\n");
console.log("<td> x" + count + "</td>\n");
console.log("<td>" + lastCard["type_name"] + "</td>\n");
console.log("<td>" + lastCard["faction_name"] + "</td>\n");
if (lastCard["traits"]) {
